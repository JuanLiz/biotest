...
namespace Biotest.Controllers
{
    ...
    public class SampleTypesController : ControllerBase
    {
        ...
        public async Task<ActionResult<SampleType>> PostSampleType(SampleType sampleType)
        {
            ...
            return CreatedAtAction("GetSampleType", new { id = sampleType.SampleTypeID }, sampleType);
        }
        ...
        {
            return _context.SampleType.Any(e => e.SampleTypeID == id);
        }
    }
}
